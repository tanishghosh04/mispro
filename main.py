...
st.write(f"The website has been shifted to: {url}. Please bookmark the new website after visiting it. This domain will be closed permanently from next month.")
